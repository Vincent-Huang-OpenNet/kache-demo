...
```shell
unzip starter.zip -d ./demo-kotlin
```
...
- Insert `springdoc-openapi-starter-webmvc-ui`, `spring-boot-starter-webflux`, and `archunit-junit5` dependency into `build.gradle.kts` file
